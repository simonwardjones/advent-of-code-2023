...
fn next_directions(d: (i32, i32), run: i32) -> Vec<((i32, i32), i32)> {
    match (d, run) {
        ((0, b), run) if run < 4 => vec![((0, b), run + 1), ((1, 0), 1), ((-1, 0), 1)],
        ((0, b), run) if run == 4 => vec![((1, 0), 1), ((-1, 0), 1)],
        ((a, 0), run) if run < 4 => vec![((a, 0), run + 1), ((0, 1), 1), ((0, -1), 1)],
        ((a, 0), run) if run == 4 => vec![((0, 1), 1), ((0, -1), 1)],
        ((-1, -1), run) => vec![((1, 0), 1), ((0, 1), 1)],
        _ => panic!("Bad d"),
    }
    // match d {
    //     (0, 1) => vec![((0, 1), run + 1), ((1, 0), 1), ((-1, 0), 1)],
    //     (0, -1) => vec![((0, -1), run + 1), ((1, 0), 1), ((-1, 0), 1)],
    //     (1, 0) => vec![((1, 0), run + 1), ((0, 1), 1), ((0, -1), 1)],
    //     (-1, 0) => vec![((-1, 0), run + 1), ((0, 1), 1), ((0, -1), 1)],
    //     (-1, -1) => vec![((1, 0), 1), ((0, 1), 1)],
    //     _ => panic!("Bad d"),
    // }
